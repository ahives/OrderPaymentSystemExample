        ...
        public NameValueCollection Configuration
        {
            get
            {
                var configuration = new NameValueCollection(13)
                {
                    ...
                    {"quartz.dataSource.default.provider", _options.Value.Provider ?? "Npgsql"},
                    {"quartz.dataSource.default.connectionString", _options.Value.ConnectionString ?? "Host=localhost;Database=Quartz;Username=admin;Password="},
